...
internal sealed class TrayIcon : IDisposable
{
    ...
    void ShowContextMenu()
    {
        ...
        NativeMethods.AppendMenu(menu, NativeMethods.MfString, (UIntPtr)NativeMethods.TrayShowPalette, "Show Tinycast");
        ...
        NativeMethods.AppendMenu(menu, NativeMethods.MfString, (UIntPtr)NativeMethods.TrayQuit, "Quit Tinycast");
