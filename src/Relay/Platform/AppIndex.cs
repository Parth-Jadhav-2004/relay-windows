...
{
    public const string InternalFormat = "RelayClipboardIgnore";
...
{
    public static IReadOnlyList<Relay.Features.FileSearch.WindowSwitchEntry> Enumerate()
    {
        var list = new List<Relay.Features.FileSearch.WindowSwitchEntry>();
