...
public sealed class LauncherCoordinator
{
    ...
    {
        yield return Cmd(BuiltinCommands.Settings, "Settings", "Open Relay settings", "\uE713");
        ...
        yield return Cmd(BuiltinCommands.Support, "Support Relay", "About and support", "\uE946");
        yield return Cmd(BuiltinCommands.Backup, "Backup", "Export a .relay archive", "\uE8B5");
        ...
        yield return Cmd(BuiltinCommands.Quit, "Quit Relay", "Leave the tray and hotkey", "\uE711");
    }
    ...
    public async void Activate(string id, bool reveal = false)
    {
        ...
        switch (id)
        {
            ...
            case BuiltinCommands.Backup:
                _core.PaletteCoordinator.HidePalette();
                _core.SettingsCoordinator.Show(Relay.Features.Settings.SettingsTab.Backup);
                break;
            case BuiltinCommands.Updates:
                _core.PaletteCoordinator.HidePalette();
                _core.SettingsCoordinator.Show(Relay.Features.Settings.SettingsTab.About);
            ...
            case BuiltinCommands.CreateLayout:
                _core.PaletteCoordinator.HidePalette();
                _core.SettingsCoordinator.Show(Relay.Features.Settings.SettingsTab.WindowManagement);
                break;
